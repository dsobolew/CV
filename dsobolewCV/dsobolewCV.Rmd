...
Data scientist and quick learner with a track record of success working with all levels of the organization. Business background with significant development experience in R, SQL, & others, as well as an exceptional ability to communicate complex concepts to a wide range of audiences. Always seeking opportunities to innovate or use new technologies while keeping user experience and business problems front and center. Passionate about data visualization and modeling to find interesting insights within complex data sets.  
...
tibble::tribble(
  ...
  "Data scientist", "Bluetree Network", "Madison, WI", "Mar. 2018 - Present", "Built forecasting models to predict patient access center call volumes and applied queueing theory principals to determing optimal staffing levels.",
    ...
    "Data scientist", "Bluetree Network", "Madison, WI", "Mar. 2018 - Present", "Performed exploratory data analyses on multiple Epic healthcare data sources and communicated results for project decision making.",
      "Data scientist", "Bluetree Network", "Madison, WI", "Mar. 2018 - Present", "Developed custom clarity and caboodle queries, validated the output, and build operational tableau dashboards for both executives and ground team members within a healthcare organization.",
    "Analytics Specialist", "Northern Trust Corporation", "Chicago, IL", "Jul. 2014 - Mar. 2018", "Developed a regression testing tool for validating financial transaction data models between development and production application environments.",
  "Analytics Specialist", "Northern Trust Corporation", "Chicago, IL", "Jul. 2014 - Mar. 2018", "Built and managed an automated processes for auditing security permissions within Nothern Trust's proprietary hedge fund administration software.",
  "Quality Assurance Analyst", "Epic", "Madison, WI", "Jul. 2011 - Jul. 2014", "Designed and tested Epic's proprietary healthcare software along side developers and implementation staff.",
    "Quality Assurance Analyst", "Epic", "Madison, WI", "Jul. 2011 - Jul. 2014", "Conducted client demos on new functionality within the HB/PB billing and Claims and Remittance Epic modules."
) %>% 
